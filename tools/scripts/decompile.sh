...
mapServerJar() {
    ...
    mvn install:install-file -Dfile=".cache/$mcVersion/server-deobf.jar" -DgroupId="xyz.nkomarn" -DartifactId="minecraft-server" -Dversion="$mcVersion-SNAPSHOT" -Dpackaging="jar" > /dev/null
    printf " Done!\n"
}
